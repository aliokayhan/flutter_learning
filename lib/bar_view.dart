...
class GroupedFillColorBarChart extends StatelessWidget {
  ...
  static List<charts.Series<OrdinalSales, String>> _createRandomData() {
    ...
    final desktopSalesData = [
      new OrdinalSales('MON', random.nextInt(100)),
      new OrdinalSales('TUE', random.nextInt(100)),
      new OrdinalSales('WED', random.nextInt(100)),
      new OrdinalSales('THU', random.nextInt(100)),
      new OrdinalSales('FRI', random.nextInt(100)),
      new OrdinalSales('SAT', random.nextInt(100)),
      new OrdinalSales('SUN', random.nextInt(100)),
    ];
    ...
    return [
      ...
      new charts.Series<OrdinalSales, String>(
        ...
        fillColorFn: (_, __) => charts.MaterialPalette.black.lighter,
      ),
    ];
  }
  // EXCLUDE_FROM_GALLERY_DOCS_END
